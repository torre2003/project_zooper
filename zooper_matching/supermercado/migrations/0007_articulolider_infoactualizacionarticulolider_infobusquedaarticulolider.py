...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('supermercado', '0006_auto_20181028_1900'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articulolider', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='supermercado.ArticuloLider')),
            ],
        ),
        migrations.CreateModel(
